...
public class ProgressDataPack extends SimplePreparableReloadListener<Map<Identifier, ProgressDefinition>> {
    ...
    private static Map<Identifier, ProgressDefinition> pendingPreparations;
    ...
    private static boolean tryApply(Map<Identifier, ProgressDefinition> preparations) {
    ...
    private static void tryApply(MinecraftServer server, Map<Identifier, ProgressDefinition> preparations) {
        ...
        Map<Identifier, ProgressDefinition> merged = new HashMap<>(BeyondPluginRunner.collectProgress());
