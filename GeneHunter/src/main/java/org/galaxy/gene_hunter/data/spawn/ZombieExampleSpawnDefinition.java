...
import static org.galaxy.gene_hunter.data.spawn.GeneHunterBossEntries.ironGolem;
import static org.galaxy.gene_hunter.data.spawn.GeneHunterSpawnEntries.entry;
...
public class ZombieExampleSpawnDefinition {
    ...
    public SpawnDefinition build() {
        return SpawnDefinition.builder()
                ...
                .bossPacks(List.of(
                        bossPack(1, ironGolem(220.0F, 16.0D, 6.0D)),
                        bossPack(2, ironGolem(320.0F, 22.0D, 10.0D)),
                        bossPack(3, ironGolem(460.0F, 30.0D, 14.0D))
                ))
                .build();
    }
