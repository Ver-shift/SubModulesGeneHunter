...
public class BeyondRogueCapInit {
    ...
    public static Optional<Holder.Reference<RogueCap>> getById(ResourceLocation id) {
        return BeyondRegistries.ROGUE_CAP.getHolder(id);
    }
    ...
    public static Supplier<RogueCap> registerCap(ResourceLocation id, Supplier<? extends RogueCap> sup) {
