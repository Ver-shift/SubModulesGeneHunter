...
public class ProgressType implements IPersistedSerializable {
    ...
    public static final ResourceLocation DEFAULT_ID = Beyond.asResource("tutorial");

    @Persisted
    private ResourceLocation id = DEFAULT_ID;
    ...
    public ProgressType(ResourceLocation id) {
        setId(id);
    }
